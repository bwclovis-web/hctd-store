...
const Modal = ({ children }) => {
  ...
  const ModalContentClasses = classNames({
    'fixed  z-30 rounded transition-all delay-300 p-4 xl:p-8 duration-500 backdrop-blur-md w-full lg:w-4/5 xl:w-2/5 pointer-none flex': true,
    'opacity-0 lg:-translate-y-80  h-auto': !animate,
