...
const AccordionItem = ({ id, question, answer }) => {
  ...
  const AccordionClasses = classNames({
    'translate-y-100 transition-all max-h-0 w-full rounded bg-sky-200/20': true,
    'opacity-0': !isActive,
  ...
  return (
    <li key={id}>
      <button
        className="relative flex items-center text-left text-xl py-3 tracking-wide gap-4 group w-full font-semibold"
